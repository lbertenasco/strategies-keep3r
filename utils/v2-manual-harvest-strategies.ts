...
export const manualHarvestStrategies = [
  //   BTC */ all of these strategies have been moved to stealth job
  //   {
  //     name: 'convex_hcrv',
  ...
  //     maxReportDelay: 60 * 60 * 24 * 1.25, // 30 hours
  //     amount: e18.mul(5),
  //   },
  //   {
  //     name: 'convex_sbtc',
  ...
  //     maxReportDelay: 60 * 60 * 24 * 6.9, // 6.9 days
  //     amount: e18.mul(200000),
  //   },
  //   {
  //     name: 'convex_yusd',
  ...
  //     maxReportDelay: 60 * 60 * 24 * 6.3, // 6.3 days
  //     amount: e18.mul(200000),
  //   },
  // { // deprecated
  //   name: 'convex_musd',
  ...
  //     maxReportDelay: 60 * 60 * 24 * 6.7, // 6.7 days
  //     amount: e18.mul(200000),
  //   },
  //   {
  //     name: 'convex_saave',
